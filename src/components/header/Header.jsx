...
import { HomeOutlined, LightModeOutlined, DarkModeOutlined, AddBoxOutlined, ExploreOutlined } from '@mui/icons-material'
	...
	return (
		<>
			...
			<Grid container className='header' sx={{ backgroundColor: 'background.paper' }}>
				...
				<Grid alignItems='center' lg={4} sm={12} className='spacer header-search' justifyContent='center'>
